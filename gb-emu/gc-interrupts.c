...
void setTimerFreq(gb *cpu){
    ...
    switch(freq){
        case 0: cpu->clockBeforeTimer = 1024 ; break ; // freq 4096
        case 1: cpu->clockBeforeTimer = 16 ; break ;// freq 262144
        case 2: cpu->clockBeforeTimer = 64 ; break ;// freq 65536
        case 3: cpu->clockBeforeTimer = 256 ; break ;// freq 16382
    }
}
...
void executeInterrupt(gb *cpu, BYTE bit){
    ...
    switch (bit)
    {
        case 0: cpu->progCounter = 0x40 ; break ;
        case 1: cpu->progCounter = 0x48 ; break ;
        case 2: cpu->progCounter = 0x50 ; break ;
        case 4: cpu->progCounter = 0x60 ; break ;
    }
